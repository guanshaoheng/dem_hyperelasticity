...
class DeepEnergyMethod:
    ...
    def train_model(self, shape, dxdydz, data, bForce, neumannBC, dirichletBC, iteration, learning_rate):
        ...
        for t in range(iteration):
            ...
            def closure():
                ...
                body_force_crit = self.intLoss.approxIntegration(bF, dx=dxdydz[0], dy=dxdydz[1], dz=dxdydz[2], shape=shape)
                ...
                for i, vali in enumerate(neuBC_coordinates):
                    ...
                    if i == 0:
                        ...
                        external2[i] = self.intLoss.lossExternalEnergy(fext, dx=hx, dy=hy, shape=[Nx, Ny])
                    elif i == 1:
...
if __name__ == '__main__':
    ...
    cf.iteration = 25
    cf.filename_out = "./output/dem/NeoHook_3Layer_lr0p5_mesh41x41x41_iter25_trap"
    dem.train_model(cf.shape, cf.dxdydz, dom, body_force, boundary_neumann, boundary_dirichlet, cf.iteration, cf.lr)

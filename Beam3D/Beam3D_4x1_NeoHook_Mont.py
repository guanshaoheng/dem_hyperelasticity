...
from dem_hyperelasticity.Beam3D import define_structure as des
...
from dem_hyperelasticity.Beam3D import config as cf
        ...
        for t in range(iteration):
            ...
            def closure():
                ...
                for i, vali in enumerate(neuBC_coordinates):
                    ...
                    external2[i] = self.intLoss.montecarlo2D(fext, LHD[1], LHD[2])
...
if __name__ == '__main__':
    ...
    start_time = time.time()
    cf.iteration = 40
    cf.filename_out = "./output/dem/NeoHook_3Layer_mesh100x25x25_iter40_mont"
